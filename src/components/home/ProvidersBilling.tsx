    ...
    <section className="py-16 sm:py-20 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            >
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-3">
                Интегрируем ИИ через официальные API ведущих провайдеров
              </h2>
              <p className="text-lg sm:text-xl text-blue-200">
                ChatGPT (OpenAI), Claude (Anthropic), Google AI, Mistral, ElevenLabs и другие — законно, прозрачно и с учётом расходов по API.
              </p>
            </motion.div>
            ...
            <p className="text-xs text-gray-400 mt-4">
              Примечание: логотипы и названия сервисов принадлежат их правообладателям.
            </p>
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <Link
                ...
                aria-label="Подробнее об интеграциях"
              >
              ...
              <Link
                ...
                aria-label="Калькулятор токенов"
              >
                Калькулятор токенов
                <ArrowRight className="h-4 w-4" />
              </Link>
          ...
          >
            <h3 className="text-xl sm:text-2xl font-semibold text-white mb-4">Прозрачный поток денег в обе стороны</h3>
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-2xl p-4 border border-yellow-400/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-yellow-100 font-medium text-sm">Как работает наша модель?</p>
                </div>
                <ul className="text-gray-200 text-xs space-y-1">
                  <li>• Вы оплачиваете фактическое использование API провайдеров</li>
                  <li>• Мы оптимизируем запросы и следим за расходами</li>
                  <li>• Прозрачная передача стоимости без наценок на API</li>
                  <li>• Детальная отчётность по каждому запросу и расходу</li>
                </ul>
              </div>
